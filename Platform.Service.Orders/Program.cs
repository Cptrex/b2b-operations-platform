...
using Platform.Service.Orders.Infrastructure.Http;
using Platform.Service.Orders.Infrastructure.Http.Clients;
using Platform.Service.Orders.Infrastructure.Http.Policies;
using Platform.Service.Orders.Infrastructure.Messaging;
using Platform.Service.Orders.Infrastructure.Security;
using Platform.Service.Orders.Infrastructure.Security.Background;
...
builder.Services.AddScoped<IRabbitMqMessageConsumer, OrdersRabbitMqConsumer>();
